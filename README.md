...
- **📊 Real-Time Analytics**: Live tracking with beautiful visualizations
...
- **Local Storage Only**: All data stored using Chrome's local storage API
...
**Made with 🧠 for mindful digital consumption**



[⭐ Star this repo](https://github.com/PratikCreates/neuroscroll) • [🐛 Report Bug](https://github.com/PratikCreates/neuroscroll/issues) • [💡 Request Feature](https://github.com/PratikCreates/neuroscroll/issues)
